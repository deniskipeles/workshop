...
type LayoutRouteId = RouteId | "/" | "/(client)/client/jobs" | "/(client)/client/jobs/[job_id]" | "/(client)/client/products" | "/(super_admin)/admin/customers" | "/(super_admin)/admin/jobs" | "/(super_admin)/admin/jobs/[job_id]" | "/(super_admin)/admin/personnel" | "/(super_admin)/admin/products" | "/about-us" | "/account" | "/ai" | "/contacts" | "/login" | "/logout" | "/register" | "/reviews" | "/services" | "/services/[service_id]" | null
type LayoutParams = RouteParams & { job_id?: string,service_id?: string }
