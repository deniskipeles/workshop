...
type LayoutRouteId = RouteId | "/(super_admin)/admin/customers" | "/(super_admin)/admin/jobs" | "/(super_admin)/admin/jobs/[job_id]" | "/(super_admin)/admin/personnel" | "/(super_admin)/admin/products"
type LayoutParams = RouteParams & { job_id?: string }
